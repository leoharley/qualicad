...
class Exportacao extends BaseController
{
    ...
    function exportaBI()
    {
        ...
        $successMsg = 'MSG TEMPORÁRIA: TABELA TMP_CONVENIO ATUALIZADA COM SUCESSO! Limit ('.($limit).') | Offset ('.($offset + 10000).') | Inseridos ('.$insertCountConvenio.') | Não inseridos ('.$notAddCountConvenio.')<br/>
