...
class Exportacao extends BaseController
{
    ...
    function exportaBI()
    {
        ...
        foreach ($exportacao as $data) {
            ...
            $data->cd_tuss_Valido, $data->ds_tuss_Valido, $data->cd_tiss_fracao, $data->Indvr, $data->Indvrfilme, 
            $data->Indvrhonor, $data->IndVrUco, $data->Vl_Venda, $data->vr_operacional, $data->vr_honorario, 
            ...
            $data->Vl_FinalProd, $data->vr_dif_vr_convenio_val_pro, $data->vr_dif_venda_custo, $data->Diverg_regra_proibicao_vl, 
