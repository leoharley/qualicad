...
function adicionaPerfil($infoPerfil)
{
    ...
    $DsTelas = array('TelaConvenio','TelaPlano','TelaIndice','TelaRegraFat','TelaUsuario','TelaFaturamento','TelaEmpresa','TelaIndiceGruproPro','TelaRegraProibicao','TelaFracaoSimproBra','TelaFaturamentoItem','TelaUnidade');
