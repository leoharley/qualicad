...
function adicionaPerfil($infoPerfil)
{
    ...
    $DsTelas = array('TelaConvenio','TelaPlano','TelaIndice','TelaRegraFat','TelaUsuario','TelaFaturamento','TelaEmpresa','TelaIndiceGrupoPro','TelaRegraProibicao','TelaFracaoSimproBra','TelaFaturamentoItem','TelaUnidade');
