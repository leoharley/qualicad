...
function adicionaPerfil($infoPerfil)
{
    ...
    $DsTelas = array('TelaConvenio','TelaPlano','TelaRegra','TelaIndice','TelaRegraFat','TelaUsuario','TelaFaturamento','TelaEmpresa','TelaIndiceGrupoPro','TelaRegraProibicao','TelaFracaoSimproBra','TelaFaturamentoItem','TelaUnidade','TelaExcecaoValores');
