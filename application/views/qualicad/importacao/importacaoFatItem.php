...
<div class="container">
    ...
    <div class="row">
        ...
        <a class="btn btn-primary" href="<?php echo base_url(). 'exportaFatItem_Imp/'.$this->session->flashdata('num_linhas_importadas'); ?>" <?php if ($this->session->flashdata('num_linhas_importadas') == null) {echo 'disabled'; echo ' onclick=\'return false;\''; } ?>>
