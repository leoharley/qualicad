    ...
    <div class="row">
        ...
        <div class="col-md-12" id="importFrm">
            <form action="<?php echo base_url() ?>importaSimproMsg" method="post" enctype="multipart/form-data">
                ...
                <p>Data de Envio: <span style="color:green"><b><?php echo date("d/m/Y", strtotime($infoMsgs[0]->Dt_Criacao)); ?></b></span></p>
                <p>Data da Atualização: <span style="color:green"><b><?php echo date("d/m/Y", strtotime($infoMsgs[0]->Dt_Criacao)); ?></b></span></p>
