                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addRegraGruPro" action="<?php echo ($this->uri->segment(2) == 'cadastrar') ? base_url().'adicionaRegraGruPro' : base_url().'editaRegraGruPro'; ?>" method="post" role="form">
                        ...
                        <div class="box-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Salva e edita regra associada(CTRL+V)" name="salvareVoltar" id="salvareVoltar" style="margin-left:5px;<?php if ($this->uri->segment(2) == 'cadastrar') { echo 'display:none'; } ?>"/>
