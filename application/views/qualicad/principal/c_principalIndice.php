                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addIndice" action="<?php echo ($this->uri->segment(2) == 'cadastrar') ? base_url().'adicionaIndice' : base_url().'editaIndice'; ?>" method="post" role="form">
                        ...
                        <div class="box-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Salvar e ir para lista (ctrl+s)" name="salvarIrLista" style="margin-left:15px;"/>
                            <input type="submit" class="btn btn-primary" value="Salvar e cadastrar outro índice (ctrl+i)" name="salvarMesmaTela" style="margin-left:15px;<?php if ($this->uri->segment(2) == 'editar') { echo 'display:none'; } ?>"/>
