<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Alterar a senha
            <small>Definir uma nova senha</small>
        </h1>
    </section>
            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Insira suas informações</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url() ?>changePassword" method="post">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputPassword2">Repita a nova senha</label>
                                        <input type="password" class="form-control" id="inputPassword2" placeholder="Repita a nova senha" name="cNewPassword"
